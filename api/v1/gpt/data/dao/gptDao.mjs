...
const getSystemRoleMessage = async (
  ...
  let positiveBeliefString =
    ` You should engage the user in cognitive restructuring techniques to challenge and convert those negative beliefs into positive ones. This can involve providing counter-evidence, reframing the situation, offering alternative perspectives, or providing affirmations and positive statements.`;
  let askInDeepString =
  ...
  let useBrahmastraString =
    ` The user is not telling anything. Meaning, maybe the user is not having any symptoms or not able to identify what user belief is. Ask the user if he is able to do so. Alse tell the user that you won't be able to help him/her further if he/she doesn't tell about his/her beliefs.`;
  ...
  if (numberOfMessages < 3) {
    ...
    if (isNegativeBelief === true) {
      systemRoleMessage += positiveBeliefString+` User is identiefied to be having negative beliefs as '${belief}'. Try to assist the user by telling the solution and converting his beliefs into positive ones. You can give him tips to recover those symptoms or beliefs.`;;
    } else {
